...
const { get_all_articles, get_one_article, delete_one_article, create_article, update_one_article_title} = require('../controllers/articles');
...
router.patch('/update/:articleid',verify, update_one_article_title);
