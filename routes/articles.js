...
const { get_all_articles, get_one_article, delete_one_article, create_article, update_one_article, get_author_articles, delete_all_articles} = require('../controllers/articles');
